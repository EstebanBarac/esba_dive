...
export default function Nosotros() {
  return (
    <div>
        ...
        <div className="lg:w-1/2 md:container md:mx-auto bg-gradient-to-r from-blue-500 to-cyan-600 m-3 text-white rounded-lg shadow-2xl shadow-slate-700">
        ...
        <div className="lg:w-1/2 md:container md:mx-auto mt-10 bg-gradient-to-r from-blue-500 to-indigo-600 m-3 text-white rounded-lg shadow-2xl shadow-slate-700">
